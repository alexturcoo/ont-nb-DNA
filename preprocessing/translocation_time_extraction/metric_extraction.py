...
#chromosomes = ["chr2", "chr3", "chr7", "chr10", "chr11", "chr12", "chr13", "chrX"] #Struggling with these HG00268

def extract_metrics_per_chr(chromosome):

    test_data_root = Path("/home/alextu/scratch/basecalling/hgsvc_pod5s/HG01457/20210727_210713_21-lee-006_PCT0053_2-A9-D9")
    pod5_dr = p5.DatasetReader(test_data_root)
    bam_fh = pysam.AlignmentFile("/home/alextu/scratch/basecalling/merged_bams/HG01457/20210727_210713_21-lee-006_PCT0053_2-A9-D9_merged.bam") # Path to your merged BAM file
    ...
    windows = pd.read_csv(f"/home/alextu/scratch/compute_windows/matched_windows/HG01457/{chromosome}_matched_windows.csv")
    ...
    for start_pos in range(smallest_start_pos, largest_end_pos, step_size):
        ...
        npy_filename = f"/home/alextu/scratch/compute_windows/extracted_metrics/extracted_metrics_hg01457/{ref_reg_pos.ctg}_{ref_reg_pos.start}_{ref_reg_pos.end}_positive.npy"
